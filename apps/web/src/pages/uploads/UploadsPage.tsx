...
/** Must stay under Vercel serverless body limit (~4.5 MB). */
...
export default function UploadsPage() {
  ...
  const onDrop = useCallback((e: React.DragEvent) => {
    ...
    if (f.size > MAX_UPLOAD_BYTES) {
      setError('File exceeds 4 MB Vercel limit. Compress or split the report.');
      setFile(null);
      return;
    }
    setError('');
  ...
  return (
    <Box>
      <PageHeader
        title="Import Data"
        subtitle="Parse in memory and import to the database. Files are not stored on disk (Vercel-safe, max 4 MB)."
      />
          ...
          <Stack spacing={2}>
            ...
            >
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                Supported: CSV, XLS, XLSX, DOC, DOCX, PDF — max 4 MB (Vercel request limit)
              </Typography>
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1}>
              ...
              <Button variant="text" onClick={() => navigate('/imports')} fullWidth={isMobile}>
                View import history
              </Button>
            </Stack>
        ...
        <DialogContent dividers>
          {preview ? (
            <Stack spacing={2}>
              ...
              {previewModule === 'BDG' ? (
                <TableContainer sx={{ maxHeight: { xs: '50vh', sm: 480 }, overflowX: 'auto' }}>
              ...
              {previewModule === 'PODS' ? (
                <Stack spacing={3}>
                  <Box>
                    ...
                    <TableContainer sx={{ maxHeight: { xs: '40vh', sm: 480 }, overflowX: 'auto' }}>
                      <Table size="small" stickyHeader sx={{ minWidth: 720 }}>
                        <TableHead>
                          <TableRow>
                            <TableCell>Row</TableCell>
